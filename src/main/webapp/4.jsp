...
<div class="container">
    <form action="markssubmit.jsp" method="post" id="marksForm">
        <div class="form-container">
            ...
            <input type="text" id="name" name="name" value="Sophia Johnson">
            ...
            <p class="total">Total Marks: <span id="totalMarks">88</span></p>
